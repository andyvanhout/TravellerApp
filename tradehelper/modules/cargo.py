...
def minor_cargo(skill_effect, population_modifier, starport_modifier, tech_level, amber_modifier, red_modifier):
    dice_modifier = skill_effect + population_modifier + starport_modifier + tech_level + amber_modifier + red_modifier
...
def incidental_cargo(skill_effect, population_modifier, starport_modifier, tech_level, amber_modifier, red_modifier):
    dice_modifier = skill_effect + population_modifier + starport_modifier + tech_level + amber_modifier + red_modifier + 2 #plus two for incidental cargo
